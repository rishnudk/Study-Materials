...
function third(arr){
  ...
  let sorted = [...new Set(Object.values(freq))].sort((a,b) => a - b)

  for(key in freq) {
    if(freq[key] === sorted[2]) {
      result.push(Number(key))
    }
  }
  return result
} 
let arr = [1,2,3,4,5,1,2,3,3,4,4,4,4,6,6,6,3,4]
